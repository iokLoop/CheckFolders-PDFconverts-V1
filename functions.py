...
class FunctionsClass():
    ...
    def SinAlpha(self,file_name,file_extension,_dirIMAGICK,_dirPDF,filename):

        print(">>>>>>>>>     Entre en la funcion SinAlpha()   <<<<<<<<<<<<<<<")
        _SnALPH="{}{}{}".format(file_name,"_SnALPH",file_extension)
        os.chdir(_dirIMAGICK)
        winCMD='{}{}{}{}{}{}{}{}'.format( "convert ", _dirPDF,"/", filename," -background white -alpha remove -alpha off ", _dirPDF,"/",_SnALPH)
        print ("\nel comando a ejecutar es : ",winCMD)
        #os.popen( _comando)
                ...
                if file_extension == f: 
                    ...
                    try:
                        ...
                        try:
                            ...
                            #os.popen( _comando)
                            cmdOutPut = subprocess.Popen(winCMD, stdout=subprocess.PIPE, shell=True).communicate()
                            pritn(string.find(str(cmdOutPut), 'YES',))
                            
                            print(" revisar sin alpha arriba de esto!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                            time.sleep(30)
                            os.chdir(_dirPDF)
